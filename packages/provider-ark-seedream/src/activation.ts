...
import type { ArkImageModelName } from "./provider.js";
...
export default {
  ...
  hostFacets: [createRuntimeEndpointAdapterFacet({
    ...
    activate(context) {
      ...
      const capabilityName = requested as ArkImageModelName;
      if (!apiKey || !context.pool) throw new Error("Ark Seedream requires apiKey and pool");
